...
const main = async () => {
  ...
  await writeFile(
    outputPath,
    `import type { OverviewData } from './types';\n\n// Generated by pnpm workbench sync. Do not edit by hand.\nexport const overviewData = ${JSON.stringify(data, null, 2)} satisfies OverviewData;\n\n// The structured warnings channel (issue #74): the seam endpoint reads these\n// straight from this module after a sync instead of scraping the console.\nexport const syncWarnings = ${JSON.stringify(trackerWarnings, null, 2)};\n`,
  );
  console.log(
