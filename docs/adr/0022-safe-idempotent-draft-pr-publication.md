...
- At the #167 baseline, Workbench repository settings did not enforce ADR 0011's documented pull-request path and defined no required exact-head PR checks. #189 owns remediation; this ADR changed no repository settings.
